...
while($row = mysql_fetch_assoc($sql)){
    if($row[$Tipas] == "video"){
      ...
      <tr><td> Video URL : '.$row[$File_dir].'</td>  </tr>
      <tr> <td>Video foto URL: '.$row[$File_name].'</td></tr>
      <tr><td><span>Pavadinimas: '.$row[$Foto_title].'  </span><a  video_url="'.$row[$File_dir].'" data-toggle="modal"  class="btn btn-primary perziura">Peržiūrėti</a><a class="btn btn-warning Video_delete" delete_reiksme="'.$rows[$Media_foto_id].'" medi="'.$id.'">Ištrinti</a></td></tr>
